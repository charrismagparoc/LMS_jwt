...
export const updateMember        = (id: number, data: Partial<Member>) => API.patch<Member>(`/members/${id}/`, data);
export const deleteMember        = (id: number) => API.delete(`/members/${id}/`);
export const toggleMemberActive  = (id: number) => API.post(`/members/${id}/toggle-active/`, {});
