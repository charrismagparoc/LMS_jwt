...
class RegisterSerializer(serializers.Serializer):
    ...
    email      = serializers.EmailField()                   # now required
    password   = serializers.CharField(write_only=True, min_length=6)
    first_name = serializers.CharField(max_length=150)
    last_name  = serializers.CharField(max_length=150, required=False, allow_blank=True, default='')
    phone      = serializers.CharField(max_length=20, required=False, allow_blank=True, default='')
    # username is auto-generated from the email local part
...
class UserSerializer(serializers.ModelSerializer):
    ...
    def get_address(self, obj):
        if hasattr(obj, 'member_profile'):
            return obj.member_profile.address or ''
        return ''

    def get_birthday(self, obj):
        if hasattr(obj, 'member_profile'):
            return str(obj.member_profile.birthday) if obj.member_profile.birthday else None
        return None

    def get_phone(self, obj):
        if hasattr(obj, 'member_profile'):
            return obj.member_profile.phone or ''
        return ''

    def get_joined_at(self, obj):
        if hasattr(obj, 'member_profile'):
            return str(obj.member_profile.joined_at) if obj.member_profile.joined_at else None
        return None
